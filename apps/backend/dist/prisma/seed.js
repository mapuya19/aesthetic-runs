...
async function main() {
    const centralParkRoute = await prisma.route.upsert({
        ...
        create: {
            ...
            slug: 'central-park',
            description: 'A scenic 5-mile run through the iconic Central Park, featuring landmarks like Bethesda Fountain and the Reservoir.',
            distance: 5,
            originLat: 40.79939,
            originLng: -73.952404,
            destLat: 40.769055,
            ...
            steps: [
                ...
                },
                {
                    ...
                    description: 'The Loch, known for its three waterfalls, is the long, narrow watercourse that flows through the Ravine in the North Woods',
                },
                ...
                { label: 'Head southwest on Loch Walking Path' },
                {
                    ...
                    description: 'Glen Span Arch, carrying the West Drive across 102nd Street, serves as a gateway to the wooded and secluded Loch to the northeast',
                },
    ...
    const hudsonRiverRoute = await prisma.route.upsert({
        ...
        create: {
            ...
            slug: 'hudson-river',
            description: 'A pleasant 1-mile run along the Hudson River waterfront from Hudson Yards to Little Island.',
            distance: 1,
            originLat: 40.754459,
            originLng: -74.002129,
            destLat: 40.742104,
    ...
    const lincolnCenterRoute = await prisma.route.upsert({
        ...
        create: {
            ...
            slug: 'lincoln-center',
            description: 'A cultural 2-mile run starting from Lincoln Center, exploring the Upper West Side.',
            distance: 2,
            originLat: 40.773261,
            originLng: -73.983197,
            destLat: 40.773261,
    ...
    const statueOfLibertyRoute = await prisma.route.upsert({
        ...
        create: {
            ...
            description: 'A 3-mile run along the Battery Park waterfront with views of the Statue of Liberty.',
            distance: 3,
            originLat: 40.703739,
            originLng: -74.017265,
            destLat: 40.703739,
